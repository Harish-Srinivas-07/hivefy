...
//   // --- Playback controls exposed to outside
...
//   List<SongDetail> get songs => state;

//   // If you also need "is playing"
//   bool get isPlaying => _player.playing;

//   int indexOfSong(String id) {
//     return state.indexWhere((s) => s.id == id);
//   }
...
//       await _player.stop();
//       _ref.read(currentSongProvider.notifier).state = null;
//       // await LastPlayedSongStorage.clear();
//     } catch (_) {}
//   }
...
//       debugPrint("[QueueManager] Loaded last played song: ${lastSong.title}");

//       try {
//         // Set player without playing
//         await _player.setAudioSource(
//           AudioSource.uri(
//             Uri.parse(lastSong.downloadUrls.last.url),
//             tag: MediaItem(
//               id: lastSong.id,
//               title: lastSong.title,
//               album: lastSong.albumName ?? '',
//               artist:
//                   lastSong.contributors.primary.isNotEmpty
//                       ? lastSong.contributors.primary
//                           .map((a) => a.title)
//                           .join(", ")
//                       : lastSong.primaryArtists,
//               genre: lastSong.albumName,
//               duration:
//                   lastSong.duration != null
//                       ? Duration(seconds: int.tryParse(lastSong.duration!) ?? 0)
//                       : null,
//               artUri:
//                   lastSong.images.isNotEmpty
//                       ? Uri.tryParse(lastSong.images.last.url)
//                       : null,
//               displayTitle: lastSong.title,
//               displaySubtitle: lastSong.albumName,
//               displayDescription: lastSong.description,
//               extras: {
//                 'label': lastSong.label,
//                 'year': lastSong.year,
//                 'releaseDate': lastSong.releaseDate,
//                 'explicit': lastSong.explicitContent.toString(),
...
//       } catch (e, st) {
//         debugPrint("QueueManager: failed to set last played song: $e\n$st");
//       }
//     }
//   }
// }
